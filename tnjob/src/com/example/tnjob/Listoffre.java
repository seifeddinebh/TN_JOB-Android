...
public class Listoffre extends Activity {
	ListView maListViewPerso;
	String id_client;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_listoffre);
		Bundle objetbunble = this.getIntent().getExtras(); 
		id_client=objetbunble.getString("id_client");
		Persist u=new Persist();
		maListViewPerso=(ListView) findViewById(R.id.listviewperso);
		ArrayList<HashMap<String, Object>> listItem = new ArrayList<HashMap<String, Object>>();
		 for(int i=0;i<u.getListcat().size();i++){
			 	HashMap<String, Object> map = new HashMap<String, Object>();
			 	 map.put("id", u.getListcat().get(i).getIdcat());
			 	map.put("name", u.getListcat().get(i).getNomcat());
		 ...
		 SimpleAdapter mSchedule = new SimpleAdapter (this.getBaseContext(), listItem, R.layout.afficheitemmm,
	             new String[] {"source", "name","id"}, new int[] {R.id.imageView1, R.id.inf1,R.id.inf2});
		       ...
		       maListViewPerso.setOnItemClickListener(new OnItemClickListener() {
		       	...
		       	@SuppressWarnings("unchecked")
		        	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
		       		...
		       		//adb.show();
						Intent intent = new Intent(Listoffre.this, Listoffrecat.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.listoffre, menu);
		return true;
	}
